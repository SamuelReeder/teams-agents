...
function loadChannels() {
  ...
  if (CHAT_ID) {
    channelsData = [{ chatId: CHAT_ID, label: "Default", prefix: null, defaultModel: null, alolaDefaultModel: null, workspace: null, maxConcurrentAgents: null }];
    return channelsData;
  }
  return [];
}
