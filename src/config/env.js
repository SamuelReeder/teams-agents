...
const HARNESS_SECRET_ENV = Object.freeze(envCsv(
  "HARNESS_SECRET_ENV",
  "OPENAI_API_KEY,ANTHROPIC_API_KEY,GOOGLE_API_KEY,GEMINI_API_KEY,MISTRAL_API_KEY,COHERE_API_KEY,OPENROUTER_API_KEY,AZURE_OPENAI_API_KEY,LLM_GATEWAY_API_KEY,LLM_GATEWAY_KEY,LLM_API_KEY,PI_API_KEY,PI_OPENAI_API_KEY,PI_ANTHROPIC_API_KEY,AWS_ACCESS_KEY_ID,AWS_SECRET_ACCESS_KEY,AWS_SESSION_TOKEN"
));
const HARNESS_VALUE_ENV = Object.freeze(envCsv(
  "HARNESS_VALUE_ENV",
  "OPENAI_BASE_URL,ANTHROPIC_BASE_URL,ANTHROPIC_CUSTOM_HEADERS,AZURE_OPENAI_ENDPOINT,AZURE_OPENAI_API_VERSION,LLM_GATEWAY_URL,PI_GATEWAY_URL,PI_PROVIDER_BASE_URL,PI_STREAM_FIRST_EVENT_TIMEOUT_MS,PI_STREAM_IDLE_TIMEOUT_MS"
));
