...
<body>
  ...
  <table>
    <tr><th>Channel</th><th>Thread</th><th>Status</th><th>From</th><th>Session</th><th>Workspace</th><th>Remote target</th><th>Age</th></tr>
  ...
  <p><code>--alola</code> keeps the harness local while selecting a durable configured remote-session target.</p>
</body>
</html>`);
});
...
app.listen(PORT, BIND_HOST, () => {
  ...
  console.log(`Remote-routed default model: ${HARNESS_CONFIG.alolaDefaultModel || "(none)"}`);
